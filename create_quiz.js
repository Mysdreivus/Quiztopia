...
function submitQuiz() {
    ...
    let databaseRef = firebase.database().ref().child("quizzes/" + category);
    let updateKey = databaseRef.push().key;
    let questions = {};
    alert("Got key: " + updateKey);
    ...
    alert("Got questions lsit");
    // TODO: user id needs to be added here
    let data = {
        name: quiz_name,
    ...
    // let newDatabaseRef = databaseRef.push(data);
